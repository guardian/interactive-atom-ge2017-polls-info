...
import DayByDay from './daybyday.js'
...
var ORDER = (["con", "libdem", "ukip", "brx", "dup", "others", "pc", "green", "snp", "lab"]).reverse();
...
// export function renderDayByDay(el, data) {

//     var dateFormat = "%d/%m/%Y";
//     var parseDate = d3.time.format(dateFormat).parse;
//     var filterTimestamp = parseDate("23/6/2016");
//     var filteredData = data.sheets["vi-continuous-series"].filter(function (d) {
//         return (d.timestamp > filterTimestamp) ? true : false;
//     })
//     new DayByDay(filteredData, {
//         container: el,
...
export default {
    renderDayByDay(el, data) {

        var dateFormat = "%d/%m/%Y";
        var parseDate = d3.timeParse(dateFormat);
        var filterTimestamp = parseDate("01/01/2019");
        var filteredData = data.sheets["vi-continuous-series"].filter(function (d) {
            return (d.timestamp > filterTimestamp) ? true : false;
        })
        new DayByDay(filteredData, {
            container: el,
            parties: ["con", "grn", "lab", "ldem", "ukip", "brx", "oth"],
            termDic: {
                con: "Con", lab: "Lab", ukip: "UKIP", ldem: "LD", grn: "Green", brx: "Brexit", oth: "Other",
                YouGov: "YouGov", Populus: "Populus", "Lord Ashcroft": "Ashcroft", Opinium: "Opinium",
                ComRes: "ComRes", ComResO: "ComRes Online", TNS: "TNS BMRB", ICM: "ICM", Ipsos: "Ipsos-MORI", Survation: "Survation"
            },
            show: 10
...
//     this.renderDayByDay = renderDayByDay(el,data);
...
//     //     renderDayByDay: function () { return renderDayByDay(el.data)}
//     // };
